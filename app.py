...
# ============================================================
# RESUME PDF TEXT EXTRACTION (STRING & OBJECT COMPATIBLE)
# ============================================================
...
def extract_resume_text(pdf_file):
    ...
    try:
        # Safe extraction for path strings or Gradio TempFile objects
        ...
        if not text:
            return (
                ...
                "Please make sure the PDF has selectable text (not scanned images)."
            )
        return text
    except Exception as e:
        return f"⚠️ Unable to read the PDF file: {str(e)}"
...
"""
    ...
    # Updated Model Fallback Chain including gemini-3.6-flash
    models_to_try = [
        "gemini-3.6-flash",
        "gemini-3.5-flash",
        "gemini-2.5-flash"
